...
namespace Skeleton.API.Core.Swashbuckle.FluentValidation
{
    ...
    public static class FluentValidationExtensions
    {
        ...
        internal static IValidator? GetValidatorFromChildValidatorAdapter(this IChildValidatorAdaptor childValidatorAdapter)
        {
            ...
            {
                var validator = (IValidator?)getValidatorGeneric.Invoke(null, [childValidatorAdapter]);
                return validator;
            }
        ...
        internal static IValidator? GetValidatorGeneric<T>(this IChildValidatorAdaptor childValidatorAdapter)
        {
            ...
            if (getValidatorMethod != null)
            {
                ...
                var validator = (IValidator?)getValidatorMethod.Invoke(childValidatorAdapter, [fakeContext, value]);
                return validator;
            }
